...
{
    public class King_Statue : ModTile
    {
        public override void SetDefaults()
        {
            ...
            TileObjectData.newTile.CoordinateHeights = new int[] { 16, 16, 16, 16, 16 };//add an extra 16 for every tile of height the tile has, this tile is 2 tall so you would have 2 16s
            ...
            name.SetDefault("Large Castle Statue");//Map name
        ...
        {
            Item.NewItem(i * 16, j * 16, 48, 32, mod.ItemType("King_Statue_Icon")); 
        }
    }
}