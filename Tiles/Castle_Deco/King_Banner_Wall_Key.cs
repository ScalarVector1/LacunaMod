...
{
    public class King_Banner_Wall_Key : ModTile
    {
        public override void SetDefaults()
        {
            ...
            name.SetDefault("Castle Key Banner");//Map name
        ...
        {
            Item.NewItem(i * 16, j * 16, 48, 32, mod.ItemType("King_Banner_Wall_Key_Icon"));
        }
    }
}