...
{
    public class FusedFlailBall : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Fused Flail Ball");
        }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture = ModLoader.GetTexture("LacunaMod/Projectiles/FusedFlailBall_Chain");
